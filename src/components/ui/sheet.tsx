...
const sheetVariants = cva(
  "fixed z-50 gap-4 border-border bg-card p-0 shadow-xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:duration-300",
  {
    variants: {
      side: {
        right:
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title ref={ref} className={cn("font-mono text-sm font-semibold text-foreground", className)} {...props} />
));
